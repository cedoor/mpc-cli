...
:tada: Thank you for being interested in contributing to the MPC-CLI project! :tada:
...
The best way to contribute to our projects is by opening a [new issue](https://github.com/cedoor/mpc-cli/issues/new/choose) or tackling one of the issues listed [here](https://github.com/cedoor/mpc-cli/contribute).
